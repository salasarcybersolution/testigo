...
Route::any('analytics',[AdminController::class,'analytics']);
Route::any('sales',[AdminController::class,'sales']);
...
Route::get('edit-account-info', [App\Http\Controllers\HomeController::class, 'accountInfo'])->name('admin.account.info');
Route::post('edit-account-info', [App\Http\Controllers\HomeController::class, 'accountInfoStore'])->name('admin.account.info.store');




Route::any('xraymachineList',[AdminController::class,'xraymachineList']);
Route::any('createXraymachine',[AdminController::class,'createXraymachine']);
Route::any('saveXrayname',[AdminController::class,'saveXrayname']);
 Route::get('editmachineName/{id}',[AdminController::class,'editmachineName']);
Route::put('updateMachinenames/{id}',[AdminController::class,'updateMachinenames']);
Route::any('deletemachinenames/{id}',[AdminController::class,'deletemachinenames']);
