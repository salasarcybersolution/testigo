 <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div class="">
                    <img src="{{asset('public/assets/images/Testigo Favicon.png')}}" class="logo-icon-2 " alt="" />
                </div>
                <div>
                    <img src="{{asset('public/assets/images/Testigo Logo Final Copy 3 (1).png')}}" class="logo-sidebar" alt="" />
                </div>
            ...
            <ul class="metismenu" id="menu">
                <li>
                    ...
                    <ul>
                        <li> <a href="{{url('/analytics')}}"><i class="bx bx-right-arrow-alt"></i>Analytics</a>
                        </li>
                ...
                <li class="menu-label">MANAGEMENT SECTION</li>
                 <li>
                    <a href="{{url('userList')}}">
                        <div class="fadeIn animated"> <i class=" bx bx-home-circle" style="font-size: 24px"></i>
                        </div>
                        <div class="menu-title">Center Management</div>
                    </a>
                </li>
                <li>
                    <a href="{{url('/doctorList')}}">
                        <div class="fadeIn animated "><i class="bx bx-donate-heart" style="font-size: 24px"></i>
                        </div>
                        <div class="menu-title">Doctor Management</div>
                    </a>
                </li>
                
                <li>
                    <a href="{{url('/OperatorList')}}">
                        <div class="fadeIn animated "><i class="bx bx-male" style="font-size: 24px"></i>
                        </div>
                        <div class="menu-title">Operator Management</div>
                    </a>
                </li>
                 <li>
                    <a href="{{url('/xraymachineList')}}">
                        <div class="parent-icon icon-color-6"><i class="bx bx-task"></i>
                        </div>
                        <div class="menu-title">X-ray Machine Management</div>
                    </a>
                </li>
                 <li>
                    <a href="{{url('/xrayList')}}">
                        ...
                        <div class="menu-title">X-ray Types Management</div>
                    </a>
                </li>
                 <li>
                    <a href="{{url('/userLists')}}">
                        <div class="fadeIn animated "><i class="bx bx-user"></i>
                        </div>
                ...
                <li>
                    <a href="#.html">
                        ...
                        <div class="menu-title">Transaction Management</div>
                    </a>
                </li>
                <li>
                    <a href="#.html">
                        ...
                        <div class="menu-title">Payout Management</div>
                    </a>
                </li>
                ...
                <li class="menu-label">CMS SECTION</li>
             <!--    <li>
                    <a href="widgets.html">
               ...
               <!--  <li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li> <a href="{{url('/pageList')}}"><i class="bx bx-right-arrow-alt"></i>Manage Pages</a>
                            </li>
                            <li> <a href="{{url('/sliderList')}}"><i class="bx bx-right-arrow-alt"></i>Slider</a>
                            </li>
                            <li> <a href="{{url('/socialmediaList')}}"><i class="bx bx-right-arrow-alt"></i>Social Media Links</a>
                            </li>
                            <li> 
                                <a href="{{url('/gallaryList')}}"><i class="bx bx-right-arrow-alt"></i>Gallary</a>
                            </li><li> <a href="{{url('/contactusList')}}"><i class="bx bx-right-arrow-alt"></i>Contact Us</a>
                            </li>
                        </ul>
                    </li>
        <!--         <li>
